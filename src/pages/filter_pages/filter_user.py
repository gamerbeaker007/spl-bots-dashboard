...
def update_user_list(tigger):
    monitoring_account = store_util.get_monitoring_account_names()
    if len(monitoring_account) == 0:
        first_account_name = ""
    else:
        first_account_name = monitoring_account[0]

    return first_account_name, store_util.get_monitoring_account_names()
